...
var getFoundersPromise = function(foundationName) { return new Promise(function(resolve, reject) {
	...
	buscada = "'" + buscada + "'";
	//console.log(buscada);
	var query1 = "SELECT DISTINCT(nombre) FROM patrons_v1 WHERE nombre_fundacion IN (" + buscada + ")";
	var elementsArray = [];
...
var getFoundationsByFounderPromise = function(founderName) { return new Promise(function(resolve, reject) {
	...
	//console.log(buscada);
	var query1 = "SELECT DISTINCT(nombre_fundacion) FROM patrons_v1 WHERE nombre IN ('" + buscada + "')";
	var elementsArray = [];
