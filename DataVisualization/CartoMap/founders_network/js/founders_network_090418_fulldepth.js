...
function paintCytoscapeNetwork(data) {
	...
	timeToPrint = cantidadNodos * 40;
	} else {
		timeToPrint = cantidadNodos * 40 * 2;
	}
  ...
  flow: { axis: 'y', minSeparation: 1000 }, // use DAG/tree flow layout if specified, e.g. { axis: 'y', minSeparation: 30 }
  flow: undefined,
